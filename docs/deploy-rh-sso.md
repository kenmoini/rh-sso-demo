## Deploying RH SSO on OpenShift

This is basically just a large YAML dump - the same YAML files can be found in the `./deploy-rh-sso/` directory for easy automation.
