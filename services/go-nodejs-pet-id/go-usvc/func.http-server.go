...
func NewRouter(basePath string) *http.ServeMux {
	...
	router.HandleFunc(basePath+"/version", func(w http.ResponseWriter, r *http.Request) {
		logNetworkRequestStdOut(r.Method+" "+basePath+"/version", r)
	...
	router.HandleFunc(basePath+"/healthz", func(w http.ResponseWriter, r *http.Request) {
		logNetworkRequestStdOut(r.Method+" "+basePath+"/healthz", r)
		fmt.Fprintf(w, "OK")
	})

	// /profile handles the data for people profiles
	router.HandleFunc(basePath+"/profile", func(w http.ResponseWriter, r *http.Request) {
		logNetworkRequestStdOut(r.Method+" "+basePath+"/profile", r)
		switch r.Method {
		case "GET":
			GetProfile(w, r)
		case "POST":
	...
	router.HandleFunc(basePath+"/pets", func(w http.ResponseWriter, r *http.Request) {
		logNetworkRequestStdOut(r.Method+" "+basePath+"/pets", r)
		switch r.Method {
		case "GET":
			GetPet(w, r)
		case "POST":
...
// DefaultEmptyErrorResponse
func DefaultEmptyErrorResponse(w http.ResponseWriter, r *http.Request) {
